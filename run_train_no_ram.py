...
def main():
    command = (
        ...
        "torchrun --nproc_per_node=8 --master_port=12345 train_no_ram.py "
        ...
        "--output_dir /home/leeyeonkyung/PRETI/EVALUATION_RESULT/PRETI_no_ram "
        "--log_dir /home/leeyeonkyung/PRETI/EVALUATION_RESULT/PRETI_no_ram "
        #=====================
