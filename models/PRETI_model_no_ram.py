...
class SiameseMAE(MAEViT):
    ...
    def compute_feature_similarity_loss(self, masked_latent, unmasked_img_no_mask):
        """Feature Consistency Loss (Cosine Similarity Loss) 계산"""
    ...
    def forward(self, imgs, meta_data, mask_ratio, max_epochs, epoch):
        ...
        masked_latent, masked_mask, masked_ids_restore, masked_age_emb, masked_gender_emb = self.forward_encoder(masked_img, mask_ratio)
